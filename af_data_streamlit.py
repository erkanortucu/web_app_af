...
# streamlit run .\af_analysis\af_data_streamlit.py
...
def data_summary():
    ...
    title_html = "<div style='text-align: center;'><h1 style='font-size: 28px;color: navy;'> 📊  Equipment Incoming to The Technical Service </h1></div>"
    ...
    title_html = "<div style='text-align: center;'><h1 style='font-size: 28px;color: navy;'> 📊  Shipped Equipments </h1></div>"
    st.markdown(title_html, unsafe_allow_html=True)
    ...
    with time1 :
        ...
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Average Bid Preparation Time  (days)   : {}</h1>".format(
    ...
    with time2 :
        ...
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Average Time the Equipment is in the Workshop (days)     : {}</h1>".format(
    ...
    with time3 :
        ...
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Average Repair Time of equipment (days)   : {}</h1>".format(
    ...
    with selectbox1:
        st.write("<h1 style='font-size: 20px;color: black;'> Select equipment class  :  </h1>",
             unsafe_allow_html=True)
    with selectbox2:
    ...
    with time4:
        ...
        st.markdown(
        "<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Average Bid Preparation Time according to equipment classes (days) : {}</h1>".format(
    ...
    with time5:
        ...
        st.markdown(
        "<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Average time the equipment is in the workshop according to equipment classes (days) : {}</h1>".format(
    ...
    with time6 :
        ...
        st.markdown(
        "<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Average Repair Time of equipment according to equipment classes (days)  : {}</h1>".format(
    ...
    with totalamount1:
        ...
        st.markdown( "<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Total Amount ( SEK )   :  {}</h1>".format(
    ...
    with totalamount2:
        ...
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Total Amount Spare Parts ( SEK ) :  {}</h1>".format(
    ...
    with totalamount3:
        ...
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Total Amount Excluding Spare Parts ( SEK ) :  {}</h1>".format(
    ...
    with ratiocol1:
        ...
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Total Spare Parts Ratio % :  {:.2f}</h1>".format(
            sp_ratio), unsafe_allow_html=True)
    #with ratiocol2:
        lab_ratio = total_amount_excl_sp / total_amount * 100
        st.markdown("<h1 style='text-align: left; color: black; font-size: 18px; font-weight: bold;background-color: #f0f0f0;'> Total Labor Amount Ratio %  :  {:.2f}</h1>".format(
